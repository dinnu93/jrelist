  ...
  $(".button-add-tag").click(function () {
    ...
    if (tag !== "") {
      $.ajax({
        ...
        last_tag = data;
        tag = data.tags.at(-1);
        $("div." + data.id).append('<span class="badge bg-secondary"><a "/tags/' + tag.id + '/episodes" class="tag-link">' + tag.name + '</a></span>');
      });
    }
...
/******/ });
//# sourceMappingURL=application-a78f5ffb4740012b0ab8.js.map